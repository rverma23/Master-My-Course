...
<header id="header" class="page-topbar">
    ...
    <div class="navbar-fixed">
        <ul id="dropdown1" class="dropdown-content">
            <c:forEach items="${sessionScope.studentCourse.courses}" var="c">
        ...
        <ul id="dropdown1_mobile" class="dropdown-content">
            ...
            <li class="divider"></li>
            <li><a href="joinCourse.htm">Join Course</a></li>
        </ul>
        <nav>
...
<div class="row messageDiv">
    ...
    <p>Your Course at Master My Course is not currently enabled please contact administration for more information.</p>
</div>
</main>
